...
$_['entry_catalog_limit'] 	    = 'Mặc định số sản phẩm hiển thị trên trang (Danh mục):<br /><span class="help">Bạn muốn bao nhiêu sản phẩm được hiển thị trên mỗi trang danh mục?</span>';
$_['entry_admin_limit']   	    = 'Mặc định số sản phẩm hiển thị trên trang (Quản trị):<br /><span class="help">Bạn muốn bao nhiêu sản phẩm sẽ được hiển thị trên mỗi trang ở phần quản lý sản phẩm?</span>';
$_['entry_product_count']          = 'Đếm số lượng sản phẩm có trong mỗi danh mục:<br /><span class="help">Hiển thị số lượng sản phẩm có trong mỗi danh mục con. Lưu ý: có thể làm chậm hệ thống!</span>';
$_['entry_review']       	       = 'Cho phép nhận xét:<br /><span class="help">Cho phép/Không cho phép khách hàng nhận xét về sản phẩm và hiển thị những nhận xét cũ.</span>';
...
$_['entry_tax_default']        = 'Sử dụng địa chỉ cửa hàng để tính thuế:<br /><span class="help">Sử dụng địa chỉ cửa hàng để tính thuế nếu không có ai được đăng nhập. Bạn có thể chọn để sử dụng địa chỉ cửa hàng cho các khách hàng vận chuyển hoặc địa chỉ thanh toán.</span>';
$_['entry_tax_customer']       = 'Sử dụng địa chỉ của khách hàng để tính thuế:<br /><span class="help">Sử dụng địa chỉ mặc định của khách hàng khi đăng nhập để tính thuế. Bạn có thể chọn sử dụng địa chỉ mặc định của khách hàng khi vận chuyển hoặc thanh toán.</span>';
...
$_['entry_order_edit']         = 'Sửa đơn hàng:<br /><span class="help">Cho phép sửa một đơn hàng sau bao nhiêu ngày? Điều này là cần thiết vì giá và giảm giá có thể thay đổi theo thời gian.</span>';
$_['entry_customer_online']        = 'Khách hàng Online:<br /><span class="help">Theo dõi khách hàng online thông qua chức năng Báo cáo khách hàng trực tuyến.</span>';
...
$_['entry_customer_group_display'] = 'Nhóm khách hàng:<br /><span class="help">Những nhóm sẽ hiển thị khi khách hàng đăng ký tài khoản.</span>';
...
$_['entry_invoice_prefix']         = 'Tiền tố hóa đơn:<br /><span class="help">Điền tiền tố cho hóa đơn (ví dụ: INV-2011-00).</span>';
$_['entry_order_status']           = 'Order Status:<br /><span class="help">Set the default order status when an order is processed.</span>';
$_['entry_affiliate']           = 'Quy định:<br /><span class="help">Khách hàng phải đồng ý với Quy định trước khi tạo tài khoản đại.</span>';
$_['entry_commission']          = 'Phần trăm hoa hồng (%):<br /><span class="help">Mặc định tỷ lệ phần trăm hoa hồng cho đại lý.</span>';
...
$_['entry_complete_status']    = 'Trạng thái cho đơn hàng hoàn thành:<br /><span class="help">Trạng thái cho đơn hàng đã hoàn thành. Sau khi đạt trang thái này khách hàng có thể tải về, sử dụng phiếu quà tặng,...</span>';
$_['entry_return']                 = 'Quy định trả hàng:<br /><span class="help">Bắt buộc khách hàng đồng ý với quy định trước khi tiến hàng trả hàng.</span>';
...
$_['entry_review']       	= 'Cho phép nhận xét:<br /><span class="help">Cho phép / Không cho phép khách hàng viết nhận xét cho sản phẩm và hiển thị các đánh giá hiện tại.</span>';
